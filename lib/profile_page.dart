...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void checkUserLoggedIn() {
    ...
    if (user == null) {
      // If no user is logged in, navigate to login page after the current frame
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              subtitle: Text(userDetails?['email'] ?? 'No email provided'),
            ),
            const Divider(),
            ListTile(
              leading: const Icon(Icons.location_on),
              title: const Text('Address'),
              subtitle: Text(userDetails?['uid'] ?? 'No address provided'),
            ),
            const Divider(),
            ListTile(
